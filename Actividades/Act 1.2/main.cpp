...
int contadorBinario(int *arreglo, int item, int longitud) {
    int minimo = 0;
    int maximo = longitud - 1;
    int contador = 0;
    ...
    return contador; // si no se encuentra
}


int contadorSecuencial(int *arreglo, int numero, int longitud) {
  int contador = 0;
...
int main() {
  ...
  for (int i = 0; i < cantidadNbuscar; i++) {
    cin >> numeroAbuscar;
    cout << busqBinaria(arrMerge, numeroAbuscar, data) << " "
         << contadorSecuencial(arrMerge, numeroAbuscar, data) << " "
         << contadorBinario(arrMerge, numeroAbuscar, data) << endl;
